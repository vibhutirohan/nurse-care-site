  ...
  const services = [
    {
      ...
      description:
        "Long-term support for conditions like diabetes, asthma, COPD, heart conditions, and mental-health-related care needs. Routine vitals, medication routines, symptom tracking, caregiver education.",
      icon: "❤️",
    },
    {
      title: "Post-Surgery Recovery Support",
      description:
        "Specialized care to help you heal safely at home after surgery. Includes wound care, pain management, mobility assistance, and recovery monitoring.",
      icon: "🏥",
    },
    {
      title: "Feeding Tube Management",
      description:
        "Expert care for patients with feeding tubes, ensuring proper nutrition and preventing complications. Note: Seizure management services are not provided.",
      icon: "🍼",
    },
    {
      title: "Emotional Support for Families",
      description:
        "Compassionate support during difficult times, helping families navigate health challenges with confidence and peace of mind.",
      icon: "🤗",
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative flex justify-center">
              <div className="bg-gradient-to-br from-[#B85C5C] to-[#8B2E2E] rounded-2xl p-8 shadow-2xl">
               ...
               <h3 className="text-xl font-semibold text-[#2B2B2B] mb-2 text-center">
  20+ Years Experience
</h3>

                <p className="text-[#6C6C6C] text-center">
  Trusted healthcare professional serving families across Connecticut
</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-[#6C6C6C] mb-6 leading-relaxed">
                Healthcare professional with over 20 years of nursing experience in pediatric nursing,
                mental health nursing, and chronic-illness care.
              </p>
              <p className="text-lg text-[#6C6C6C] mb-8 leading-relaxed">
                Healing happens best at home — my care combines expertise with true compassion.
              </p>
      ...
      <section className="py-20 bg-[#8B2E2E]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-red-100 mb-8">
            Schedule your free 15-minute consultation to discuss your care needs.
          </p>
          <Link
            to="/contact"
